...
class TambahPemasukanFragment : Fragment() {
    private var _binding: FragmentTambahPemasukanBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTambahPemasukanBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.simpanButton.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_tambahPemasukanFragment_to_SecondFragment)
        }
